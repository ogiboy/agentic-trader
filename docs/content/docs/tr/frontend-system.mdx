...
Web GUI control room da aynı yöne gidiyor: üst seviye component state/render coordinator olarak kalmalı; view dosyaları, shell chrome, dashboard polling, action handler'ları, request helper'ları, primitive'ler ve typed dil bazlı İngilizce/Türkçe copy ayrı modüllerde durmalı.
...
İlk control-room bölünmesi ve ana view-copy katalogu tamam; sonraki işler coordinator'u tekrar büyütmeden typed view model'leri, katalog-aware helper satırlarını ve ekran kapsamlı stilleri ayırmalı.
