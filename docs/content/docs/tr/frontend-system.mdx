...
Poetry Python bağımlılık yöneticisi olarak kalır; Makefile hedefleri yalnızca pnpm ve Poetry komutlarına ince alias'lardır.
...
- feedback mesajlarında local kayıt ile opsiyonel GitHub forwarding ayrımını net yaz
