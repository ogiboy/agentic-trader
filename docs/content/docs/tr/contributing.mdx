...
- Web GUI: pnpm install, lint, typecheck ve production build
- Docs: pnpm install, lint, typecheck ve static export
- Release tag'leri: GitHub Release'e eklenen macOS ve Windows PyInstaller binary'leri
