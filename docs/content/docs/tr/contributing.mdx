...
title: Katkı Vermek
description:
  Çalışma tarzı, branch hijyeni ve değişiklikleri güvenli ve okunabilir tutan
  beklentiler.
---
...
Conventional commit tarzı tercih edilir; çünkü release otomasyonu ve tarihçe
daha okunabilir kalır. Örnekler:
...
- `V1`, `V2` gibi integration branch'leri: `v0.9.6-next.9870+gabc1234` gibi
  `next` prerelease'leri
...
- Version Check: semantic-release preview ve SemVer uyumlu branch artifact
  kimliği
- Binaries: branch testleri için macOS ve Windows PyInstaller artifact'leri;
  `v*` tag'lerinde stabil GitHub Release'e, branch push'larında prerelease
