...
Sadece `main` otomatik olarak `pyproject.toml` ve `CHANGELOG.md` değiştirir. Diğer branch'ler version preview çalıştırır ve test binary'leri için prerelease tag/release kayıtları yayınlayabilir:
