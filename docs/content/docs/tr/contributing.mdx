...
Sadece `main` otomatik olarak `pyproject.toml`, `CHANGELOG.md`, Git tag'leri ve GitHub Release kayıtlarını değiştirir. Diğer branch'ler version preview çalıştırır ve test artifact'leri üretebilir:

- `main`: `v0.9.5` gibi stabil SemVer tag'leri
- `V1`, `V2` gibi integration branch'leri: `v0.9.6-next.9870+gabc1234` gibi `next` artifact'leri
- feature branch'leri: `v0.9.6-beta.9870+gabc1234` gibi `beta` artifact'leri
...
- Binaries: branch testleri için macOS ve Windows PyInstaller artifact'leri; sadece release tag'lerinde GitHub Release'e eklenir
