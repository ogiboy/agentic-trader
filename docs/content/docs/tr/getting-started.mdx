...
- Docs'e özel GitHub feedback ayarları `docs/.env.local` içinde yaşamalı.

Docs feedback akışının GitHub Discussions'a da iletmesini istiyorsan `docs/.env.example` dosyasını `docs/.env.local` olarak kopyalayıp şunları ekle:

- `GITHUB_APP_ID`
- `GITHUB_APP_PRIVATE_KEY`
- isteğe bağlı `DOCS_FEEDBACK_GITHUB_OWNER`
- isteğe bağlı `DOCS_FEEDBACK_GITHUB_REPO`
- isteğe bağlı `DOCS_FEEDBACK_GITHUB_CATEGORY`
