...
The Web GUI Proposal Desk reads the same queue and can only call those explicit
approve, reject, reconcile, or refresh contracts. It is not a generic broker
console and does not create orders outside the proposal queue.
