...
Only `main` mutates `pyproject.toml` and `CHANGELOG.md` automatically. Other branches run a version preview and may publish prerelease tags/releases for test binaries:
