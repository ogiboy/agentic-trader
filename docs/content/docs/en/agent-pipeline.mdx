...
description:
  How context becomes specialist analysis, manager output, and guarded execution
  without hidden leaps.
---

## Why the pipeline matters

The repo is not asking a single chat prompt to improvise a trade. It is
assembling typed context, routing it through specialist stages, and applying a
deterministic guard before anything reaches execution.
...
- different behavior between permissive training paths and strict operational
  paths
