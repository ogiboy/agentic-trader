...
description:
  How Agentic Trader keeps local paper operation, observer surfaces, research
  evidence, and secrets bounded.
---
...
- supported active trading is gated, and ungated real-money execution is blocked
  by default
