...
Poetry remains the Python dependency manager; Makefile targets are thin aliases over pnpm and Poetry commands.
...
- keep feedback messaging unambiguous about storage and forwarding behavior
