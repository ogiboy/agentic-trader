...
If GitHub authentication, `gh`, release preview, or the requested PR base is
unavailable or unclear, stop before publishing and ask for the missing remote
context. Do not default to `main`, auto-merge, or manufacture a PR body from
...
If validation cannot be completed, keep the PR body honest: list skipped checks,
the reason, and the product risk. A partial validation result must not be worded
as merge-ready.
