...
- keep `sidecars/research_flow/` as a tracked but subprocess-only CrewAI Flow uv workspace member; root `pnpm check` should stay focused on the core runtime until the sidecar is mature enough for a separate CI job
