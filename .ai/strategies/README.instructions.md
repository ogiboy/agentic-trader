...
If one of these references is missing or renamed, report the path and continue
from the current runtime contracts and strategy catalog. Do not invent strategy
behavior from a missing playbook.
...
- Missing or stale evidence blocks proposal confidence instead of becoming a
  neutral score.

## Current Durable Catalog

Read `v1-strategy-catalog.instructions.md` before adding scanner presets,
backtest baselines, or proposal-enrichment logic.
