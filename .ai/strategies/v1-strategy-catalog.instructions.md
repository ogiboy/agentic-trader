...
This catalog translates benchmark strategy ideas into Agentic Trader's V1
contracts. Strategy ideas may become scanner scores, backtest baselines, or
pending proposals. They must not become direct execution.

If required market, catalyst, liquidity, or risk evidence is unavailable, keep
the output as watch/research evidence and name the missing fields. Do not create
proposal-ready language from incomplete evidence.
...
Required before strategy output is considered desk-grade:
