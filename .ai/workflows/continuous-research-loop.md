...
Before a loop cycle can spend real provider or browser work, it should confirm:
...
Monitor work should be cheap and structured:
...
core decision layer. Every packet should preserve:
...
Each cycle digest should be small, durable, and inspectable:
...
Digest memory should improve review and replay, not silently change policy.
