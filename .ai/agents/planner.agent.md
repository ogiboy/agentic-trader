...
If a required file, QA scenario, or source surface is missing, record the exact
path and plan from the remaining evidence. If the owner contract stays
unclear, stop at questions instead of guessing an implementation.
