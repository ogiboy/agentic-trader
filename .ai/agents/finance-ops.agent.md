...
If adapter health, account snapshots, fills, marks, or persisted finance rows
are missing or inconsistent, report the mismatch and block any claim that needs
that evidence. A missing number is not zero unless the owning source confirms
zero.
