...
SONAR_COVERAGE_EXCLUSIONS="${SONAR_COVERAGE_EXCLUSIONS:-${SONAR_EXCLUSIONS},tui/**,agentic_trader/tui_modules/**,agentic_trader/cli_modules/*_commands.py,agentic_trader/cli_modules/*_rendering.py,agentic_trader/cli_modules/*_reports.py}"
