    ...
    *, status: StrategyStatus | None = None, preset: IdeaPresetName | None = None
    ...
    Returns:
        dict[str, object]: A payload with the following keys:
            ...
            - "filters": object echoing the supplied `status` and `preset` values.
            - "execution_policy": human-readable text describing required proposal/approval policy for entries.
            - "validation_policy": dict of fixed validation flags governing lookahead, confidence requirements, and runtime import rules.
    """
