...
EN_MESSAGES_COPY: dict[str, str] = {
    ...
    "message_artifact_label_invalid": "Artifact label must be a single directory name.",
    "message_background_service_started": "Orchestrator is running in the background with PID {pid}.",
    ...
    "message_no_new_results_before_stop": "No new results were produced before the orchestrator stopped.",
